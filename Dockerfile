...
# Install bzip2/zstd to enable native decompression
# RUN apt-get update
...
CMD ["java", "-XX:-UseCompressedClassPointers", "-XX:+ExitOnOutOfMemoryError", "-jar", "/usr/src/parser/target/stats-0.1.0.jar", "5600"]
